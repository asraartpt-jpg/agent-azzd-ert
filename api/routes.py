...
async def generate_full_paper(request: GeneratePaperRequest):
    ...
    try:
        ...
        # Enforce selected publisher style formatting
        style = state.target_journal if state.target_journal else "Taylor & Francis / Routledge"
        state = orchestrator.route_request(state, "writing", user_input=f"{style} style")
